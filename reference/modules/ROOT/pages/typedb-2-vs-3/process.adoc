...
. Refresh your knowledge and adjust to the new versions of TypeDB and TypeQL by following the updated xref:{page-version}@learn-typedb::quickstart/setup.adoc[Quickstart] guide.
...
Use the TypeDB 2.x export command to export your TypeDB 2.x database as a schema definition file and a data file.
